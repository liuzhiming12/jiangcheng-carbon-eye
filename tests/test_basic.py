def estimate_co2(cpu_percent, duration_seconds, tdp_watts=15, om_factor=0.4044):
...
def test_full_load():
    ...
    expected = (15.0 * 1.0 / 1000.0) * 0.4044
    assert abs(result - expected) < 1e-9

def test_om_factor():
    assert abs(estimate_co2(100.0, 3600, 1000, 0.4044) - 0.4044) < 1e-9
